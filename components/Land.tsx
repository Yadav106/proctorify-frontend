      ...
      <div className="relative h-screen">
        ...
        <div className="absolute top-0 left-0 w-full h-screen text-white bg-[#586c94] flex flex-col justify-center items-center align-center opacity-80">
          ...
          <div className="flex flex-row">
            <button className="border border-white border-solid rounded-md py-2 px-4 mt-10 m-2.5 font-bold bg-gradient-to-r from-black to-blue-900 hover:from-blue-900 hover:to-blue-900 transition-colors duration-300" onClick={goToAuth}>
              Get Started
            </button>
